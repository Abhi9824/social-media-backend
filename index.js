    ...
    try {
      ...
      if (files && files.length > 0) {
        ...
        mediaArray = files.map((file) => ({
          public_id: file.filename, // Cloudinary public ID (generated by multer-storage-cloudinary)
          url: file.path, // Cloudinary URL (generated by multer-storage-cloudinary)
        }));
      }
